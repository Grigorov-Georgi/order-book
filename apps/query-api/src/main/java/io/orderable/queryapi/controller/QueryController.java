...
public class QueryController {
    ...
    ResponseEntity<String> getOrdersBySymbolRange(@RequestParam String symbol,
    ...
    @GetMapping("/user")
    ResponseEntity<String> getUserOrders(@RequestHeader(name = "X-User-Id", required = true) String authSub) {
        ...
        return ResponseEntity.ok("user-orders: externalUserKey=" + externalUserKey + ", internalUserId=" + internalUserId);
    }
}
